experiment_name="vit3d-radfm_perceiver-radfm_llama2-7b-chat-hf_iu"

CUDA_VISIBLE_DEVICES=7,1 torchrun --nproc_per_node=2 /home/chenzhixuan/Workspace/LLM4CTRG/src/train_iu.py \
    --bf16 True \
