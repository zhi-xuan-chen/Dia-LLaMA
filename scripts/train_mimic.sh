experiment_name="vit3d-radfm_perceiver-radfm_llama2-7b-chat-hf_ctr_prompt_mimic"

CUDA_VISIBLE_DEVICES=3,1 torchrun --nproc_per_node=2 /home/chenzhixuan/Workspace/LLM4CTRG/src/train_mimic.py \
    --bf16 True \
