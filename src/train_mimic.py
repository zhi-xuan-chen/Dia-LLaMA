...
from Dataset.mimic_dataset_train import dataset_train
...
class DataCollator(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        vision_xs, lang_xs, cls_labels, attention_masks, labels,loss_reweight,key_words_query = tuple([instance[key] for instance in instances] for key in ('vision_x','lang_x', 'cls_labels','attention_mask', 'labels', 'loss_reweight','key_words_query'))
