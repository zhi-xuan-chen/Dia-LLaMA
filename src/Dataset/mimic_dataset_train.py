...
class dataset_train(Dataset):
    def __init__(self, text_tokenizer, max_seq=2048, max_img_size=1, image_num=32, voc_size=32000):
        ...
        mimic_dataset = MIMIC_Dataset(
            data_dir='/jhcnas1/chenzhixuan/data/mimic-cxr-jpg/images_resized/',
            data_json = '/jhcnas1/chenzhixuan/data/mimic-cxr-jpg/annotation_with_label.json',
            split = 'train',
            prompt_json_file='/home/chenzhixuan/Workspace/LLM4CTRG/src/Dataset/my_dataset/report_prompt.json', down_sample_ratio=1)
        self.dataset_reflect['mimic_dataset'] = mimic_dataset
        self.data_whole_3D = self.data_whole_3D + \
            [{'mimic_dataset': i} for i in range(len(mimic_dataset))]
        print('mimic_dataset loaded')
